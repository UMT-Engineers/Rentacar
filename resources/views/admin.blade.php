...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=" treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.html"><i class="fa fa-cab"></i> Add Car</a></li>
        ...
        <li class=" treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.html"><i class="fa fa-user-plus"></i> Add Driers</a></li>
 ...
 <li class=" treeview">
  ...
  <ul class="treeview-menu">
    <li><a href="index.html"><i class="fa fa-user-plus"></i> Add Customers</a></li>
